...
/**
 * class Cosinus for computing cosinus value of number.
 * @author vladradishevsky
 * @since 19/02/2016
 * @version 1.0
 **/
public class Cosinus extends UserAction {
     ...
     */
    public Cosinus(Input input, Calculator calculator, String info) {
    ...
    public double execute(double... params) {
        ...
        this.getCalculator().setResult(Math.cos(param));
